	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
                ...
                <li><g:link class="list" action="index"><g:message code="${domainClass.propertyName}.list.label"  default="Elenco"/></g:link></li>
		...
		<div id="edit-${domainClass.propertyName}" class="content scaffold-edit" role="main">
            <h1><g:message code="${domainClass.propertyName}.edit.label" args="[entityName]" default="Modifica"/></h1>
