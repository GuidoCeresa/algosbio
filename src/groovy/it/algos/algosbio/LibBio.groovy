...
class LibBio {
    ...
    public static final String MAX_VOCI_PAGINA_ATTIVITA = 'maxVociPaginaAttivita'
    public static final String MAX_VOCI_PARAGRAFO_COGNOMI = 'maxVociParagrafoCognomi'
    ...
    public static final String USA_SUDDIVISIONE_UOMO_DONNA_ATT = 'usaSuddivisioneUomoDonnaAtt'
    ...
    public static final String USA_LISTE_BIO_NAZIONALITA = 'usaListeBioNazionalita'
    public static final String USA_LISTE_BIO_ATTIVITA = 'usaListeBioAttivita'
    public static final String USA_LISTE_BIO_NOMI = 'usaListeBioNomi'
    public static final String USA_LISTE_BIO_COGNOMI = 'usaListeBioCognomi'
