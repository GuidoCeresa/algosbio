 ...
 */
class ListaCognomeAttivita extends ListaCognome {


    public ListaCognomeAttivita(Cognome cognome) {
        super(cognome)
    }// fine del costruttore


    public ListaCognomeAttivita(String soggetto) {
        super(soggetto)
    }// fine del costruttore


    public ListaCognomeAttivita(String soggetto, boolean iniziaSubito) {
