...
<head>
    ...
    <title><g:message code="bioWiki.edit.label" args="[entityName]" default="Modifica"/></title>
</head>
<body>
<a href="#edit-bioWiki" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="edit-bioWiki" class="content scaffold-edit" role="main">
    <h1><g:message code="bioWiki.edit.label" args="[entityName]" default="Aggiungi"/></h1>
    ...
    <g:hiddenField name="version" value="${bioWikiInstance?.version}" />
    <fieldset class="form">
