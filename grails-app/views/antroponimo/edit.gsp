...
<head>
    ...
    <title><g:message code="antroponimo.edit.label" args="[entityName]" default="Modifica"/></title>
</head>
<body>
...
<div id="edit-antroponimo" class="content scaffold-edit" role="main">
    <h1><g:message code="antroponimo.edit.label" args="[entityName]" default="Aggiungi"/></h1>
