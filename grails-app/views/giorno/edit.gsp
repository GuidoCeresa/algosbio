...
<head>
    ...
    <title><g:message code="giorno.edit.label" args="[entityName]" default="Modifica"/></title>
</head>
<body>
<a href="#edit-giorno" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="edit-giorno" class="content scaffold-edit" role="main">
    <h1><g:message code="giorno.edit.label" args="[entityName]" default="Aggiungi"/></h1>
