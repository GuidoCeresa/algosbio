	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
                ...
                <li><g:link class="list" action="index"><g:message code="anno.list.label"  default="Elenco"/></g:link></li>
		...
		<div id="edit-anno" class="content scaffold-edit" role="main">
            <h1><g:message code="anno.edit.label" args="[entityName]" default="Modifica"/></h1>
			...
			<g:form url="[resource:annoInstance, action:'update']" method="PUT" >
