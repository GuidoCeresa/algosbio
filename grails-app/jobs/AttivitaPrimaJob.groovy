...
class AttivitaPrimaJob extends BioCrono {
    ...
    private static String attivitaPrimaMetaPrimaSettimana = "0 0 $ORA_INIZIO ? * $GIORNO_ATT#1" //--primo giovedi del mese
    private static String attivitaPrimaMetaTerzaSettimana = "0 0 $ORA_INIZIO ? * $GIORNO_ATT#3" //--terzo giovedi del mese
